...
// Day 19 blank focus: scale the Hopper tile to fast.cu's 128x256x64 shape.
#include "challenge_todo.cuh"


// FILL-IN BLANKS FOR THIS FILE
//   [ ] Blank A: explain why 128x256 gives more WGMMA work per CTA than 64x64.
//   [ ] Blank B: explain why BK=64 groups four m64nNk16 WGMMA K steps.
//   [ ] Blank C: compare register pressure and occupancy against Day 17 and Day 18.
//   [ ] Blank D: benchmark 1024/2048/4096 and note where the bigger tile wins.
//   [ ] Blank E: identify why scheduling still matters after tile tuning.
...
using Day19FastCuBigTileConfig = day19_standalone::HopperFastCuConfig<
    128, 256, 64,
    1, 1,
    day19_standalone::SchedulerKind::OneCtaPerTile>;
...
void sgemm_cutlass_hopper_fastcu_big_tile_bf16(
    ...
    torch::Tensor &output_matrix)
{
    day19_standalone::torch_wrapper<Day19FastCuBigTileConfig>(
        matrix_a, matrix_b, output_matrix, "Day 19 Hopper 128x256x64 GEMM");
}
