...
namespace day19_solution_standalone {
...
using Day19FastCuBigTileConfig = day19_solution_standalone::HopperFastCuConfig<
    128, 256, 64,
    1, 1,
    day19_solution_standalone::SchedulerKind::OneCtaPerTile>;
...
void sgemm_cutlass_hopper_fastcu_big_tile_bf16(
    ...
    torch::Tensor &output_matrix)
{
    day19_solution_standalone::torch_wrapper<Day19FastCuBigTileConfig>(
