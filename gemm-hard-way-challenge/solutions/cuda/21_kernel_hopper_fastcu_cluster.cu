...
namespace day21_solution_standalone {
...
using Day21FastCuClusterConfig = day21_solution_standalone::HopperFastCuConfig<
    128, 256, 64,
    2, 1,
    day21_solution_standalone::SchedulerKind::Persistent>;
...
void sgemm_cutlass_hopper_fastcu_cluster_bf16(
    ...
    torch::Tensor &output_matrix)
{
    day21_solution_standalone::torch_wrapper<Day21FastCuClusterConfig>(
