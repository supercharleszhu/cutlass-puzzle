...
namespace day20_solution_standalone {
...
using Day20FastCuPersistentConfig = day20_solution_standalone::HopperFastCuConfig<
    128, 256, 64,
    1, 1,
    day20_solution_standalone::SchedulerKind::Persistent>;
...
void sgemm_cutlass_hopper_fastcu_persistent_bf16(
    ...
    torch::Tensor &output_matrix)
{
    day20_solution_standalone::torch_wrapper<Day20FastCuPersistentConfig>(
